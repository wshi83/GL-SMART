...
def main():
    ...
    time_len = '1year' #6month, 1year, 2year
    ...
    raw_train_data = pd.read_csv(
        '/home/wenqi/GL-SMART-aim2/pre-processed-data-MCID/pp_data_preop_{}.csv'.format(time_len))
    ...
    X_test_single = x_test[random_indice]
    X_test_multiple = x_test[random_indice:random_indice+10]
