...
def main():
    ...
    raw_train_data = pd.read_csv(
        pwd + '/pre-processed-data/pp_data_preop_{}.csv'.format(time_len))
    ...
    # problem_id = 0  # 0-21 for Q1-Q22
    for problem_id in range(22):
        ...
        models_folder = pwd + '/weighted_loss/deep-models-{}/{}/'.format(
        ...
        # print('==================================================')
        print('Class 0: Negative; Class 1: Positive. For Q{}: The prediction categories are: {}; The predicted confidences are: {}.'.format(
            problem_id+1, PRO_preds, PRO_confidence))

        PRO_preds_list.append(PRO_preds)
        PRO_confidence_list.append(PRO_confidence)
        ...
        # print(y.values)
    # print(PRO_preds_list)
    # print(PRO_confidence_list)
