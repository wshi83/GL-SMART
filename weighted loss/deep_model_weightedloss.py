...
raw_train_data = pd.read_csv(
    '/home/wenqi/GL-SMART-aim2/pre-processed-data/pp_data_preop_{}.csv'.format(args.time_len))
...
file_path = os.path.join(
    '/home/wenqi/GL-SMART-aim2/weighted_loss/deep-models-{}/'.format(args.time_len), focus_label+'/')
if not os.path.exists(file_path):
    os.makedirs(file_path)
    os.makedirs(os.path.join(file_path, 'results/'))
    os.makedirs(os.path.join(file_path, 'tensorboards/'))
data_path = '/home/wenqi/GL-SMART-aim2/pre-processed-data/pp_data_preop_{}.csv'.format(
    args.time_len)
models_folder = '/home/wenqi/GL-SMART-aim2/weighted_loss/deep-models-{}/{}/'.format(
    args.time_len, focus_label)
tensorboard_folder = '/home/wenqi/GL-SMART-aim2/weighted_loss/deep-models-{}/{}/tensorboard/'.format(
    args.time_len, focus_label)

# Create results spreadsheet if it does not already exist
results_file = '/home/wenqi/GL-SMART-aim2/weighted_loss/deep-models-{}/{}/results/Validation-80Trained_HPTuneSpreadsheet.csv'.format(
    args.time_len, focus_label)
