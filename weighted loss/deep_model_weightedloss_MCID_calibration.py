...
file_path = os.path.join(
    '/home/wenqi/GL-SMART-aim2/deep_model_weighted_loss_MCID/deep-models-{}/'.format(args.time_len), focus_label+'/')
...
data_path = '/home/wenqi/GL-SMART-aim2/pre-processed-data-MCID/pp_data_preop_{}.csv'.format(
    args.time_len)
models_folder = '/home/wenqi/GL-SMART-aim2/deep_model_weighted_loss_MCID/deep-models-{}/{}/'.format(
    args.time_len, focus_label)
tensorboard_folder = '/home/wenqi/GL-SMART-aim2/deep_model_weighted_loss_MCID/deep-models-{}/{}/tensorboard/'.format(
    args.time_len, focus_label)

# Create results spreadsheet if it does not already exist
results_file = '/home/wenqi/GL-SMART-aim2/deep_model_weighted_loss_MCID/deep-models-{}/{}/results/Validation-80Trained_HPTuneSpreadsheet.csv'.format(
    args.time_len, focus_label)
...
with torch.no_grad():
    ...
    fig_path = '/home/wenqi/GL-SMART-aim2/Figures/NoCalibration_weighted/{}_{}_{}.png'.format(args.time_len, focus_label, args.dropout1_p)
